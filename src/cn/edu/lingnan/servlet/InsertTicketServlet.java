...
//		System.out.print("到达InsertTicketServlet");
			...
			System.out.println("从修改页面获取的数据为："+tid+"   "+flightNumber+"   "+destination+"    "+offDate+"   "+price+"   "+allowance+"   "+status);
		    ...
		    boolean flag = tdao.insertTicket(tdto);
