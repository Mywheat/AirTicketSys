...
<!-- Begin page -->
		...
		<div class="content-page">
			...
			<div class="content">
				<div class="card-box">
				<p style="margin-bottom:20px;margin-left:20px"><font size=4px>添加用户</font></p>
					<!-- Row start -->
			  		<div class="am-g">
	 ...
	 <div class="am-g">
		<div class="am-u-sm-12">
          <form action="../insertUserServlet" class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
	              <tr>
	                <th class="table-title">ID</th><th class="table-title">用户名</th><th class="table-type">电话</th><th class="table-author am-hide-sm-only">密码</th><th class="table-date am-hide-sm-only">权限</th><th class="table-set">状态</th><th class="table-set">操作</th>
	              </tr>
              </thead>
              <tbody>
	        <tr>
	            ...
	            <td><input type="text" name="superuser" value=""></td>
