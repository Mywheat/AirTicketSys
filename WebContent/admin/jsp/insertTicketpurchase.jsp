...
<!-- Begin page -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
						        <li><a href="showAllUser.jsp" class="am-cf"> 查看用户</span></a></li>
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        <li><a href="showAllTicket.jsp" class="am-cf"> 查看机票</span></a></li>
						    ...
						    <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
						        ...
						        <li><a href="insertTicketpurchase.jsp">添加机票订单</a></li>   
						      </ul>
						    </li>
						  </ul>
				</div>
		...
		<div class="content-page">
			...
			<div class="content">
				<div class="card-box">
				<p style="margin-bottom:20px;margin-left:20px"><font size=4px>订购机票</font></p>
					<!-- Row start -->
					<div class="am-g">
	 ...
	 <div class="am-g">
		<div class="am-u-sm-12">
          <form action="../insertTicketpurchaseServlet" class="am-form">
	        ...
	        <tr>
	            ...
	            <td><input type="text" name="purchaseDate" value=""></td>
	            <td><input type="text" name="status" readOnly="true" value="0"></td>     
	            <td><input type="submit" class="am-btn am-btn-default am-btn-xs am-text-secondary" onClick="check();" value="确认添加"></td>
	        </tr>
            </tbody>
      </table>
      </form>     
