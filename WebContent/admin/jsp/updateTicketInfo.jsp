...
<!-- Begin page -->
		...
		<div class="content-page">
			...
			<div class="content">
				<div class="card-box">
				<p style="margin-bottom:20px;margin-left:20px"><font size=4px>修改机票信息</font></p>
					<!-- Row start -->
					<div class="am-g">
	 ...
	 <div class="am-g">
		<div class="am-u-sm-12">
          <form action="../updateTicketServlet" class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              <thead>
	              <tr>
	                <th class="table-title">ID</th><th class="table-title">航班号</th><th class="table-type">目的地</th><th class="table-author am-hide-sm-only">起飞时间</th><th class="table-date am-hide-sm-only">价格</th><th class="table-date am-hide-sm-only">余量</th><th class="table-set">状态</th><th class="table-set">操作</th>
	              </tr>
              </thead>
              <tbody>
	             <%
        		...
        		%>
		        <tr>
		            <td><input type="text" readOnly="true" name="tid" value=<%=t.getTid()%>></td>
		            <td><input type="text" name="flightNumber" value=<%=t.getFlightNumber()%>></td>
		            <td><input type="text" name="destination" value=<%=t.getDestination()%>></td>
		            <td><input type="text" name="offDate" value=<%=t.getOffDate()%>></td>
		            <td><input type="text" name="price" value=<%=t.getPrice()%>></td>
		            <td><input type="text" name="allowance" value=<%=t.getAllowance()%>></td>
      ...
      <li><img src="../assets/img/backward.png" style="margin-left:910px"><a href="showAllTicket.jsp" style="float:right;margin-right:35px"><font size=2>返回</font></a></li>
      </div>
      </div>
</body>
